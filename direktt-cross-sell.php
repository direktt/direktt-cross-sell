...
function direktt_cross_sell_render_use_coupon( $use_coupon_id ) {
	...
	if ( ! $coupon ) {
		...
		if ( ! $disable_use && empty( $status_message ) ) {
			?>
			<form method="post" action="" onsubmit="return direkttCSConfirmCouponUse('<?php echo esc_js( $group_title ); ?>');" class="direktt-profile-data-cross-sell-tool-single-coupon-form">
